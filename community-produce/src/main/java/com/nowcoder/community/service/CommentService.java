...
public class CommentService implements CommunityConstant {
    ...
    public List<Comment> findCommentsByEntity(int entityType, int entityId, int offest, int limit) {
        return commentMapper.selectCommentsByEntity(entityType, entityId, offest, limit);
    }
